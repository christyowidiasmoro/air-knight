...
export class Player extends Physics.Arcade.Sprite {
    ...
    private playerState: "waiting" | "start" | "can_move" = "waiting";

    private propulsion_fire!: Phaser.GameObjects.Sprite;
    ...
    start() {
        ...
        this.scene.tweens.add({
            ...
            onComplete: () => {
                ...
                this.playerState = "can_move";
            }
        });
    }

    move(direction: string) {
        if(this.playerState === "can_move") {
