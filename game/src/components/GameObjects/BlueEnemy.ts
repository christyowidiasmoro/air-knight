...
export class BlueEnemy extends Physics.Arcade.Sprite {
    private animation_is_playing: boolean = false;
    private damage_life_point: number = 3;
    private scale_damage: number = 4;
    private up_down_tween!: Phaser.Tweens.Tween;
    ...
    damage(player_x: number, player_y: number) {
        console.log("Enemy damaged! Score should increase."); // Debug log
